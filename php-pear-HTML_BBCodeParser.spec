...
# Source0-md5:	85a665b0ecb2a8489c2a1875d2ddf2fd
...
install %{_pearname}-%{version}%{_pre}/%{_subclass}/Filter/*.php $RPM_BUILD_ROOT%{php_pear_dir}/%{_class}/%{_subclass}/Filter
...
%doc %{_pearname}-%{version}%{_pre}/%{_subclass}/example
